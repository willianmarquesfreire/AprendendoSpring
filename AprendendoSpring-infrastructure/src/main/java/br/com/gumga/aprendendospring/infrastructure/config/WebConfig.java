...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = {"br.com.gumga.aprendendospring.presentation.web", "gumga.framework"})
...
public class WebConfig extends WebMvcConfigurerAdapter implements WebApplicationInitializer {
    ...
    public GumgaRequestFilter gumgaRequestFilter() {
        return new GumgaRequestFilter("br.com.gumga.aprendendospring.AprendendoSpring");
    }
