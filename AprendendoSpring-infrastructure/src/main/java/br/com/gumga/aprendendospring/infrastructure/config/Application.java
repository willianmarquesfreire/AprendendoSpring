...
@Configuration
@ComponentScan(basePackages = {"br.com.gumga.aprendendospring", "gumga.framework"})
@EnableJpaRepositories(repositoryFactoryBeanClass = GumgaRepositoryFactoryBean.class, basePackages = {"br.com.gumga.aprendendospring", "gumga.framework"})
...
//        config.addDataSourceProperty("url", "jdbc:mysql://localhost:3306/AprendendoSpring?zeroDateTimeBehavior=convertToNull");
...
//        config.addDataSourceProperty("password", "senha");
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        factory.setPackagesToScan("gumga.framework.domain","br.com.gumga.aprendendospring");
